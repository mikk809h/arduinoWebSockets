...
#define EIO_HEARTBEAT_INTERVAL 60000
...
public:
    ...
    void beginSSLWithCA(const char *host, uint16_t port, const char *CA_cert, const char *url = "/socket.io/?EIO=3", const char *protocol = "arduino");
